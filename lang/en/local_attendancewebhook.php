...
$string['notification_attendances'] = 'Attendances:';
$string['notification_contact_admin'] = 'Please contact the administrator.';
$string['notification_error_attendances'] = 'The following attendances of the event could not be incorporated:';
$string['notification_error_event'] = 'The following event could not be incorporated:';
$string['notification_subject'] = 'Error notification';
